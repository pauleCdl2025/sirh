              ...
              <div className="employee-meta">
                ...
                {employee.statut_employe && (
                  <span className="badge bg-secondary ms-2">
                    {decodeHtmlEntities(employee.statut_employe)}
                  </span>
                )}
                {employee.nationalite && (
                  <span className="badge bg-primary ms-2">
                    {decodeHtmlEntities(employee.nationalite)}
                  </span>
                )}
              </div>
            </div>
                  ...
                  <div className="info-section">
                    ...
                    <div className="info-grid">
                      ...
                      <div className="info-item">
                        ...
                        <span className="info-value">{decodeHtmlEntities(employee.statut_marital) || 'Non spécifié'}</span>
                      </div>
                      <div className="info-item">
                      ...
                      <div className="info-item">
                        ...
                        <span className="info-value">{decodeHtmlEntities(employee.nationalite) || 'Non spécifié'}</span>
                      </div>
                      <div className="info-item">
                  ...
                  <div className="info-section mt-4">
                    ...
                    <div className="info-grid">
                      ...
                      <div className="info-item">
                        ...
                        <span className="info-value">{decodeHtmlEntities(employee.responsable) || 'Non spécifié'}</span>
                      </div>
                      <div className="info-item">
                        <span className="info-label">Niveau d'étude</span>
                        <span className="info-value">{decodeHtmlEntities(employee.niveau_etude) || 'Non spécifié'}</span>
                      </div>
                      <div className="info-item">
                        <span className="info-label">Spécialisation</span>
                        <span className="info-value">{decodeHtmlEntities(employee.specialisation) || 'Non spécifié'}</span>
                      </div>
                      <div className="info-item">
